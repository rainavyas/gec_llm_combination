...
if __name__ == '__main__':
    ...
    tp, fp, fn = errant_spoken(get_file_data(args.hyp_asr), get_file_data(args.hyp_gec), get_file_data(args.ref_gec), get_file_data(args.ref_asr))
